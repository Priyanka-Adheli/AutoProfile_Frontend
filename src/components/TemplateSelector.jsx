...
const TemplateSelector = ({selectedTemplate,onChange}) =>{
    ...
    },
    {
        id: "modern",
        name: "Modern",
        preview: "A sleek, contemporary layout with bold headings and dynamic use of color and spacing."
    },
    {
        id: "minimal",
        name: "Minimal",
        preview: "A simple, elegant design with ample white space and subtle typography for a refined look."
    },
    {
        id: "minimal-image",
        name: "Minimal Image",
        preview: "A minimalist layout featuring a profile image, ideal for personal branding and creative roles."
    }
];
    return(
